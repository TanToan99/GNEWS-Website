...
var snowStorm = (function(window, document) {
    ...
    this.snowCharacter = '<img src="https://gnewsclub.com/storage/9/e14-40x40px.png" />'; // &bull; = bullet, &middot; is square on some systems etc.
    ...
    this.flakeWidth = 100; // Max pixel width reserved for snow element
    this.flakeHeight = 100; // Max pixel height reserved for snow element
