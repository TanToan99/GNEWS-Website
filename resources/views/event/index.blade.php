    ...
    <div class="event-main">
        <div class="bg-element-1">
            <video autoplay muted loop id="myVideo" >
                <source  src="/images/event-element/bg-motion.mp4" type="video/mp4">
            </video>
        </div>
        <div class="event-tree">
            <h1 class="tree-text-h1">Ban đang có <span>5</span> lượt hái</h1>
            <img class="tree-img" src="/images/event-element/tree.png"/>
        ...
        <div class="event-chat">
            ...
            <div class="event-chat-main">
                <p><span>Van Loc: </span> heloo ae</p>
                <p><span>Van Loc: </span> heloo aeheloo aeheloo aeheloo aeheloo aeheloo ae</p>
                <p><span>Van Loc: </span> heloo ae.........</p>
            </div>
            <div class="event-chat-input">
                <div class="input-gr">
                    <img src="{{ auth()->user()->avatar }}" />
                    <input type="text" placeholder="Hãy trò chuyện chút nào!">
                    <button type="submit"><i class="fas fa-paper-plane"></i></button>
                </div> 
            </div>
        </div>
        <div class="event-noti">
            <p><span>Van Loc: </span>Đã trúng con iphone 13 pro max!!! </p>
            <p><span>Van Loc: </span>Đã trúng con iphone 13 pro max!! </p>
            <p><span>Van Loc: </span>Đã trúng con iphone 13 pro max!</p>
        </div>
    </div>
