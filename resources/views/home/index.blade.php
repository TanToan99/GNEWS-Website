                    ...
                    <div class="card-body ">
                        ...
                        <div class="tab-content">
                            <div class="tab-pane active">
                                <p class="title text-center">Vũ Thu Thủy</p>
            ...
            <div class="col-md-4">
                <div class="card">
                    <div class="card-body ">
                        ...
                        <div class="tab-content">
                            <div class="tab-pane active">
                                <p class="title text-center">Hồ Ngọc Trâm Anh</p>
            ...
            <div class="col-md-4">
                <div class="card">
                    <div class="card-body ">
                        ...
                        <div class="tab-content">
                            <div class="tab-pane active">
                                <p class="title text-center">Lữ Quốc Đạt</p>
